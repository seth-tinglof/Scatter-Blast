...
This function should be passed a size two double array; index 0 will be set to the ratio of the new screen width over the old
and index one will be set to the ratio of the new screen height over the old.*/
